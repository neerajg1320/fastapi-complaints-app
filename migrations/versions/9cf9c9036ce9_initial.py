...
Revision ID: 9cf9c9036ce9
Revises: 
Create Date: 2024-01-20 11:30:09.127360
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('pending', 'approved', 'rejected', name='complaintstate'), server_default='pending', nullable=False),
